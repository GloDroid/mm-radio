      ...
      pub mod radio {
        ...
        pub mod RadioConst {
          ...
          impl binder::Parcelable for r#RadioConst {
            fn write_to_parcel(&self, parcel: &mut binder::binder_impl::BorrowedParcel) -> std::result::Result<(), binder::StatusCode> {
              parcel.sized_write(|_subparcel| {
                Ok(())
              })
            }
            fn read_from_parcel(&mut self, parcel: &binder::binder_impl::BorrowedParcel) -> std::result::Result<(), binder::StatusCode> {
              parcel.sized_read(|_subparcel| {
                Ok(())
              })
            }
          }
          ...
          impl binder::binder_impl::ParcelableMetadata for r#RadioConst {
            fn get_descriptor() -> &'static str { "android.hardware.radio.RadioConst" }
        ...
        pub mod RadioResponseInfo {
          ...
          pub struct r#RadioResponseInfo {
            pub r#type: crate::mangled::_7_android_8_hardware_5_radio_17_RadioResponseType,
            pub r#serial: i32,
          ...
          impl binder::binder_impl::ParcelableMetadata for r#RadioResponseInfo {
            fn get_descriptor() -> &'static str { "android.hardware.radio.RadioResponseInfo" }
            fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
          }
          pub(crate) mod mangled {
        ...
        pub mod RadioResponseInfoModem {
          ...
          impl binder::binder_impl::ParcelableMetadata for r#RadioResponseInfoModem {
            fn get_descriptor() -> &'static str { "android.hardware.radio.RadioResponseInfoModem" }
            fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
          }
          pub(crate) mod mangled {
