...
extern "C" {
    pub fn __fdelt_warn(__d: ::std::os::raw::c_long) -> ::std::os::raw::c_long;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " This must be called with a position that has been previously returned from"]
    #[doc = " AParcel_getDataPosition. If writes are made after setting the data position, they must"]
    #[doc = " be made in the exact same sequence used before resetting data position. Writing over"]
    #[doc = " objects such as binders or file descriptors is not supported."]
    #[doc = ""]
    #[doc = " Available since API level 29."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "     AIBinder_DeathRecipient_delete, after any pending onBinderDied calls"]
    #[doc = "     finish."]
...
#[doc = " ownership of the binder named 'registered'."]
#[doc = ""]
#[doc = " WARNING: a lock is held when this method is called in order to prevent races with"]
#[doc = " AServiceManager_NotificationRegistration_delete. Do not make synchronous binder calls when"]
#[doc = " implementing this method to avoid deadlocks."]
#[doc = ""]
#[doc = " \\param instance instance name of service registered"]
#[doc = " \\param registered ownership-passed instance of service registered"]
#[doc = " \\param cookie data passed during registration for notifications"]
...
extern "C" {
    ...
    #[doc = " you will immediately get a notification."]
    #[doc = ""]
    #[doc = " WARNING: it is strongly recommended to use AServiceManager_waitForService API instead."]
    #[doc = " That API will wait synchronously, which is what you usually want in cases, including"]
    #[doc = " using some feature or during boot up. There is a history of bugs where waiting for"]
    #[doc = " notifications like this races with service startup. Also, when this API is used, a service"]
    #[doc = " bug will result in silent failure (rather than a debuggable deadlock). Furthermore, there"]
    #[doc = " is a history of this API being used to know when a service is up as a proxy for whethre"]
    #[doc = " that service should be started. This should only be used if you are intending to get"]
    #[doc = " ahold of the service as a client. For lazy services, whether a service is registered"]
    #[doc = " should not be used as a proxy for when it should be registered, which is only known"]
    #[doc = " by the real client."]
    #[doc = ""]
    #[doc = " WARNING: if you use this API, you must also ensure that you check missing services are"]
    #[doc = " started and crash otherwise. If service failures are ignored, the system rots."]
    #[doc = ""]
    #[doc = " \\param instance name of service to wait for notifications about"]
    #[doc = " \\param onRegister callback for when service is registered"]
    #[doc = " \\param cookie data associated with this callback"]
    #[doc = ""]
    #[doc = " \\return the token for this registration. Deleting this token will unregister."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " After this method is called, the callback is guaranteed to no longer be invoked. This will block"]
    #[doc = " until any in-progress onRegister callbacks have completed. It is therefore safe to immediately"]
    #[doc = " destroy the void* cookie that was registered when this method returns."]
    #[doc = ""]
    #[doc = " \\param notification object to dismiss"]
...
extern "C" {
    ...
    #[doc = " \\param instance identifier of the service"]
    #[doc = " \\param context to pass to callback"]
    #[doc = " \\param callback taking the APEX name (e.g. 'com.android.foo') and context"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Do not use this from a library. Apps setup their own threadpools, and otherwise, the main"]
    #[doc = " function should be responsible for configuring the threadpool for the entire application."]
...
extern "C" {
    ...
    #[doc = " This tells whether someone in the process has called ABinderProcess_startThreadPool. Usually,"]
    #[doc = " you should use this in a library to abort if the threadpool is not started."]
    #[doc = " Programs should configure binder threadpools once at the beginning."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " WARNING: you must hold on to a binder instance after this is set, while you"]
    #[doc = " are using it. If you get a binder (e.g. `...->asBinder().get()`), you must"]
    #[doc = " save this binder and then"]
    #[doc = " use it. For instance:"]
    #[doc = ""]
    #[doc = "     auto binder = ...->asBinder();"]
    #[doc = "     AIBinder_forceDowngradeToSystemStability(binder.get());"]
    #[doc = "     doSomething(binder);"]
